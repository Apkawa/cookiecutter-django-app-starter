...
copyright = '{{cookiecutter.current_year}}, {{cookiecutter.full_legal_name_of_project_owner}}'
author = '{{cookiecutter.full_legal_name_of_project_owner}}'
...
def setup(app):
    git_doc_root = '{{cookiecutter.repo_url}}/blob/master/docs/'
